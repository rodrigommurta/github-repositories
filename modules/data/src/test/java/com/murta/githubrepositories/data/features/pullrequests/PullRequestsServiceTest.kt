        ...
        runBlocking {
            ...
            with(result) {
                ...
                with(first()) {
                    ...
                    assertEquals(
                        body,
                        "The JAR format has a lot of single int writes. Without buffering, " +
                ...
                with(last()) {
                    ...
                    assertEquals(
                        body,
                        "LibraryFilterCachingService shared service was being registered through" +
                                " rootProject. That breaks Gradle Isolated Projects (see KT-54105)\r\n\r\nInstead," +
                                " register through the current project, as shared services are shared through the entire build."
                    )
